...
#if !defined(ESP_SIGNER_DISABLE_ONBOARD_WIFI)

#define ESP_SIGNER_WIFI_IS_AVAILABLE
...
#define ESP_SIGNER_HAS_WIFI_DISCONNECT
#endif
...
#define ESP_SIGNER_HAS_WIFI_TIME
#endif

#if defined(MB_ARDUINO_PICO) && __has_include(<WiFiMulti.h>)
#define ESP_SIGNER_HAS_WIFIMULTI
#endif
...
#if !defined(ESP_SIGNER_DISABLE_NATIVE_ETHERNET)
...
#if defined(ESP_SIGNER_TINYGSM_IS_AVAILABLE) && __has_include(<TinyGsmClient.h>)
#include <TinyGsmClient.h>
#define ESP_SIGNER_GSM_MODEM_IS_AVAILABLE
#endif
