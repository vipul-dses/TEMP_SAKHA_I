...
#define ENABLE_WEIGHT_PRINT
#ifdef ENABLE_WEIGHT_PRINT
#define WEIGHT_PRINT(...) Serial.print(__VA_ARGS__)
#define WEIGHT_PRINTLN(...) Serial.println(__VA_ARGS__)
#else
#define WEIGHT_PRINTLN(...)
#define WEIGHT_PRINTLN(...)
#endif
